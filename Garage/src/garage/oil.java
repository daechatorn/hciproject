 ...
 * @author Student Lab
 */
public class oil extends javax.swing.JFrame {

    /**
     * Creates new form oil
     */
    public oil() {
        initComponents();
        setVisible(true);
    ...
    private void initComponents() {
        ...
        oiltype = new javax.swing.JComboBox();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        jLabel1.setText("Reception - ถ่ายน้ำมันเครื่อง");
        ...
        oiltype.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "oil1", "oil2", "oil3", "oil4" }));
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(oiltype, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(oiltype, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String message = oiltype.getSelectedItem().toString();
        ...
        if (message != null && message.length() > 0) {
            ...
            for (Frame frame : Frame.getFrames()) {
                ...
                if (frame.getTitle().equals("Reception")) {
                    ...
                    setNewMessage = "Detail : น้ำมัน " + message;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(oil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JComboBox oiltype;
